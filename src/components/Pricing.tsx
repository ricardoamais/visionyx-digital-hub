    ...
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-[#185FA5]/20 text-[#185FA5] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-8">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-[#185FA5] hover:bg-[#185FA5]/90 text-white w-full sm:w-auto px-8 md:px-12 py-4 md:py-5 rounded-xl text-base md:text-lg font-bold shadow-xl shadow-[#185FA5]/20 transition-all hover:-translate-y-1"
          >
            Agendar Agora
          </a>
        </div>
