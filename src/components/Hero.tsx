    ...
    <div className="container mx-auto px-4 text-center relative z-10">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-500 text-foreground px-8 py-4 rounded-xl text-lg font-semibold transition-all hover:scale-105 box-glow"
